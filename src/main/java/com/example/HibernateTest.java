...
public class HibernateTest {
    ...
    public static void displaySiswa(Transaction tx) {
        ...
        String[] header = { "ID", "Nama", "Umur", "Jurusan" };
        int[] columnLengths = new int[header.length];

        for (Students students : getresult) {
            String[] data = { String.valueOf(students.getId()), students.getName(),
                    String.valueOf(students.getAge()), students.getMajor() };
        ...
        String judul = "Daftar Data Siswa";
